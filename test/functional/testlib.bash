...
export SWUPD_COULDNT_INSTALL_BUNDLE=15  # Cannot install bundles
export SWUPD_COULDNT_CREATE_DIRS=16  # Cannot create required dirs
export SWUPD_CURRENT_VERSION_UNKNOWN=17  # Cannot determine current OS version
export SWUPD_COULDNT_VERIFY_SIGNATURE=18  # Cannot initialize signature verification
export SWUPD_BAD_TIME=19  # System time is bad
export SWUPD_COULDNT_DOWNLOAD_PACK=20  # Pack download failed
export SWUPD_BAD_CERT=21  # unable to verify server SSL certificate
export SWUPD_REQUIRED_BUNDLE_ERROR=22  # a required bundle is missing or was attempted to be removed
export SWUPD_INVALID_BUNDLE=23  # the specified bundle is invalid
