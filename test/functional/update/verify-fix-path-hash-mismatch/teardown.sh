...
sudo chown $(ls -l setup.sh | awk '{ print $3 ":" $4 }') web-dir/10/files/cde33514c151abb2b01448be290ab1d5212952571d15e3533cadc15ff82f2cd5
...
sudo rm -rf target-dir/usr/bin/foo
