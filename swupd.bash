...
_swupd()
{
    ...
    do case "${COMP_WORDS[$i]}" in
		...
		break;;
	    ("bundle-add")
		opts="--help --url --contenturl --versionurl --port --path --format --force --nosigcheck --ignore-time --statedir --certpath --time --no-scripts --no-boot-update "
		break;;
	    ("bundle-remove")
		...
		break;;
	    ("update")
		opts="--help --download --url --port --contenturl --versionurl --status --format --path --force --nosigcheck --ignore-time --statedir --certpath --time --no-scripts --no-boot-update --migrate --allow-mix-collisions "
		break;;
	    ("verify")
		opts="--help --manifest --path --url --port --contenturl --versionurl --fix --picky --picky-tree --picky-whitelist --install --format --quick --force --nosigcheck --ignore-time --statedir --certpath --time --no-scripts --no-boot-update "
		break;;
	    ("check-update")
