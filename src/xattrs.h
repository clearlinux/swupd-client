...
/**
 * @file
 * @brief Process extended attributes (xattrs) from files.
 */

#include <stdlib.h>

/**
 * @brief Best effort to copy the extended attributes from one file to another.
 *
...
/**
 * @brief Attempt to pack into a data blob the extended attributes of the given file.
 *
 ...
 * comparison.
 * @returns 0 if the extended attributes are identical, -1 if they are
 * different.
 */
