...
@test "UPD056: Updating a system using machine readable output" {
	...
	expected_output1=$(cat <<-EOM
		...
		{ "type" : "progress", "currentStep" : 2, "totalSteps" : 9, "stepCompletion" : -1, "stepDescription" : "run_preupdate_scripts" },
		{ "type" : "progress", "currentStep" : 2, "totalSteps" : 9, "stepCompletion" : 100, "stepDescription" : "run_preupdate_scripts" },
		{ "type" : "progress", "currentStep" : 3, "totalSteps" : 9, "stepCompletion" : 0, "stepDescription" : "download_packs" },
		{ "type" : "info", "msg" : "Downloading packs for:" },
		{ "type" : "info", "msg" : " - test-bundle" },
	EOM
	)
	expected_output2=$(cat <<-EOM
		{ "type" : "progress", "currentStep" : 3, "totalSteps" : 9, "stepCompletion" : 100, "stepDescription" : "download_packs" },
		{ "type" : "info", "msg" : "Finishing packs extraction..." },
		{ "type" : "progress", "currentStep" : 4, "totalSteps" : 9, "stepCompletion" : -1, "stepDescription" : "extract_packs" },
		{ "type" : "progress", "currentStep" : 4, "totalSteps" : 9, "stepCompletion" : 100, "stepDescription" : "extract_packs" },
		{ "type" : "progress", "currentStep" : 5, "totalSteps" : 9, "stepCompletion" : -1, "stepDescription" : "prepare_for_update" },
		...
		{ "type" : "progress", "currentStep" : 5, "totalSteps" : 9, "stepCompletion" : 100, "stepDescription" : "prepare_for_update" },
		...
		{ "type" : "progress", "currentStep" : 8, "totalSteps" : 9, "stepCompletion" : 0, "stepDescription" : "update_files" },
		{ "type" : "info", "msg" : "Installing files..." },
		{ "type" : "progress", "currentStep" : 8, "totalSteps" : 9, "stepCompletion" : 16, "stepDescription" : "update_files" },
		{ "type" : "progress", "currentStep" : 8, "totalSteps" : 9, "stepCompletion" : 33, "stepDescription" : "update_files" },
		{ "type" : "progress", "currentStep" : 8, "totalSteps" : 9, "stepCompletion" : 50, "stepDescription" : "update_files" },
		{ "type" : "progress", "currentStep" : 8, "totalSteps" : 9, "stepCompletion" : 66, "stepDescription" : "update_files" },
		{ "type" : "progress", "currentStep" : 8, "totalSteps" : 9, "stepCompletion" : 83, "stepDescription" : "update_files" },
		{ "type" : "progress", "currentStep" : 8, "totalSteps" : 9, "stepCompletion" : 100, "stepDescription" : "update_files" },
