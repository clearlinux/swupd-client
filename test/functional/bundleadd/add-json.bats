...
@test "ADD049: Adding a bundle using machine readable output" {
	...
	expected_output1=$(cat <<-EOM
		...
		{ "type" : "progress", "currentStep" : 1, "totalSteps" : 7, "stepCompletion" : -1, "stepDescription" : "load_manifests" },
		{ "type" : "progress", "currentStep" : 1, "totalSteps" : 7, "stepCompletion" : 100, "stepDescription" : "load_manifests" },
		{ "type" : "progress", "currentStep" : 2, "totalSteps" : 7, "stepCompletion" : 0, "stepDescription" : "download_packs" },
		{ "type" : "info", "msg" : "Downloading packs for:" },
		{ "type" : "info", "msg" : " - test-bundle" },
	EOM
	)
	expected_output2=$(cat <<-EOM
		{ "type" : "progress", "currentStep" : 2, "totalSteps" : 7, "stepCompletion" : 100, "stepDescription" : "download_packs" },
		{ "type" : "info", "msg" : "Finishing packs extraction..." },
		{ "type" : "progress", "currentStep" : 3, "totalSteps" : 7, "stepCompletion" : -1, "stepDescription" : "extract_packs" },
		{ "type" : "progress", "currentStep" : 3, "totalSteps" : 7, "stepCompletion" : 100, "stepDescription" : "extract_packs" },
		{ "type" : "progress", "currentStep" : 4, "totalSteps" : 7, "stepCompletion" : 0, "stepDescription" : "download_fullfiles" },
		{ "type" : "info", "msg" : "No extra files need to be downloaded" },
		{ "type" : "progress", "currentStep" : 4, "totalSteps" : 7, "stepCompletion" : 100, "stepDescription" : "download_fullfiles" },
		{ "type" : "progress", "currentStep" : 5, "totalSteps" : 7, "stepCompletion" : -1, "stepDescription" : "extract_fullfiles" },
		{ "type" : "progress", "currentStep" : 5, "totalSteps" : 7, "stepCompletion" : 100, "stepDescription" : "extract_fullfiles" },
		{ "type" : "progress", "currentStep" : 6, "totalSteps" : 7, "stepCompletion" : 0, "stepDescription" : "install_files" },
		...
		{ "type" : "progress", "currentStep" : 7, "totalSteps" : 7, "stepCompletion" : -1, "stepDescription" : "run_scripts" },
