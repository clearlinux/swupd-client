...
# This script creates a _swupd function to be used by
# completion built-in bash command to complete swup
# It reads options and subcommands from swup --help
# Also it reads options for each subcommand recursively
