...
@test "INS013: OS install using machine readable output" {
	...
	expected_output1=$(cat <<-EOM
		...
		{ "type" : "progress", "currentStep" : 4, "totalSteps" : 10, "stepCompletion" : -1, "stepDescription" : "consolidate_files" },
	...
	expected_output2=$(cat <<-EOM
		{ "type" : "progress", "currentStep" : 5, "totalSteps" : 10, "stepCompletion" : 100, "stepDescription" : "download_packs" },
		{ "type" : "info", "msg" : "Finishing packs extraction... " },
		{ "type" : "progress", "currentStep" : 6, "totalSteps" : 10, "stepCompletion" : -1, "stepDescription" : "pack_extraction" },
		{ "type" : "progress", "currentStep" : 6, "totalSteps" : 10, "stepCompletion" : 100, "stepDescription" : "pack_extraction" },
		{ "type" : "info", "msg" : "Checking for corrupt files " },
		{ "type" : "progress", "currentStep" : 7, "totalSteps" : 10, "stepCompletion" : 50, "stepDescription" : "check_files_hash" },
		{ "type" : "progress", "currentStep" : 7, "totalSteps" : 10, "stepCompletion" : 100, "stepDescription" : "check_files_hash" },
		{ "type" : "info", "msg" : "No extra files need to be downloaded " },
		{ "type" : "progress", "currentStep" : 8, "totalSteps" : 10, "stepCompletion" : 100, "stepDescription" : "download_fullfiles" },
		{ "type" : "info", "msg" : " Installing base OS and selected bundles " },
		{ "type" : "progress", "currentStep" : 9, "totalSteps" : 10, "stepCompletion" : 50, "stepDescription" : "add_missing_files" },
		{ "type" : "progress", "currentStep" : 9, "totalSteps" : 10, "stepCompletion" : 100, "stepDescription" : "add_missing_files" },
