...
@test "UPD056: Updating a system using machine readable output" {
	...
	expected_output1=$(cat <<-EOM
		...
		{ "type" : "progress", "currentStep" : 1, "totalSteps" : 12, "stepCompletion" : 100, "stepDescription" : "prepare_for_update" },
		{ "type" : "info", "msg" : "Preparing to update from 10 to 20 " },
		{ "type" : "progress", "currentStep" : 2, "totalSteps" : 12, "stepCompletion" : 100, "stepDescription" : "get_versions" },
		{ "type" : "progress", "currentStep" : 3, "totalSteps" : 12, "stepCompletion" : 100, "stepDescription" : "cleanup_download_dir" },
		{ "type" : "progress", "currentStep" : 4, "totalSteps" : 12, "stepCompletion" : 100, "stepDescription" : "load_manifests" },
		{ "type" : "progress", "currentStep" : 5, "totalSteps" : 12, "stepCompletion" : 100, "stepDescription" : "run_preupdate_scripts" },
		{ "type" : "info", "msg" : "Downloading packs for: " },
		{ "type" : "info", "msg" : " - test-bundle " },
	EOM
	)
	expected_output2=$(cat <<-EOM
		{ "type" : "progress", "currentStep" : 6, "totalSteps" : 12, "stepCompletion" : 100, "stepDescription" : "download_packs" },
		{ "type" : "info", "msg" : "Finishing packs extraction... " },
		{ "type" : "progress", "currentStep" : 7, "totalSteps" : 12, "stepCompletion" : -1, "stepDescription" : "pack_extraction" },
		{ "type" : "progress", "currentStep" : 7, "totalSteps" : 12, "stepCompletion" : 100, "stepDescription" : "pack_extraction" },
		{ "type" : "progress", "currentStep" : 8, "totalSteps" : 12, "stepCompletion" : 100, "stepDescription" : "apply_deltas" },
		...
		{ "type" : "progress", "currentStep" : 9, "totalSteps" : 12, "stepCompletion" : 100, "stepDescription" : "create_update_list" },
		{ "type" : "info", "msg" : "No extra files need to be downloaded " },
		{ "type" : "progress", "currentStep" : 10, "totalSteps" : 12, "stepCompletion" : 100, "stepDescription" : "download_fullfiles" },
		{ "type" : "info", "msg" : "Staging file content " },
		{ "type" : "info", "msg" : "Applying update " },
		{ "type" : "progress", "currentStep" : 11, "totalSteps" : 12, "stepCompletion" : 33, "stepDescription" : "update_files" },
		{ "type" : "progress", "currentStep" : 11, "totalSteps" : 12, "stepCompletion" : 66, "stepDescription" : "update_files" },
		{ "type" : "progress", "currentStep" : 11, "totalSteps" : 12, "stepCompletion" : 100, "stepDescription" : "update_files" },
		{ "type" : "info", "msg" : "Update was applied " },
		{ "type" : "info", "msg" : "Calling post-update helper scripts " },
		{ "type" : "progress", "currentStep" : 12, "totalSteps" : 12, "stepCompletion" : 100, "stepDescription" : "run_postupdate_scripts" },
	EOM
	)
