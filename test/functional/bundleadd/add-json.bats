...
@test "ADD049: Adding a bundle using machine readable output" {
	...
	expected_output1=$(cat <<-EOM
		...
		{ "type" : "progress", "currentStep" : 2, "totalSteps" : 8, "stepCompletion" : 100, "stepDescription" : "consolidate_files" },
		{ "type" : "progress", "currentStep" : 3, "totalSteps" : 8, "stepCompletion" : 100, "stepDescription" : "check_disk_space_availability" },
		{ "type" : "info", "msg" : "Downloading packs for: " },
		{ "type" : "info", "msg" : " - test-bundle " },
	EOM
	)
	expected_output2=$(cat <<-EOM
		{ "type" : "progress", "currentStep" : 4, "totalSteps" : 8, "stepCompletion" : 100, "stepDescription" : "download_packs" },
		{ "type" : "info", "msg" : "Finishing packs extraction... " },
		{ "type" : "progress", "currentStep" : 5, "totalSteps" : 8, "stepCompletion" : -1, "stepDescription" : "pack_extraction" },
		{ "type" : "progress", "currentStep" : 5, "totalSteps" : 8, "stepCompletion" : 100, "stepDescription" : "pack_extraction" },
